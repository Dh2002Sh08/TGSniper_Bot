...
const NETWORK_CONFIGS = {
    ETH: {
        ...
        rpc: `https://distinguished-twilight-lake.quiknode.pro/${process.env.ETH_QUICKNODE_KEY}`,
    ...
    BSC: {
        ...
        rpc: `https://thrilling-late-dawn.bsc.quiknode.pro/${process.env.BSC_QUICKNODE_KEY}`,
        explorer: 'https://bscscan.com/tx/',
        factory: '0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73'
    },
    SOL: {
        router: 'routeUGWgWzqBWFcrCfv8tritsqukccJPu3q5GPP3xS', // Raydium AMM Pool
        rpc: `https://snowy-stylish-panorama.solana-mainnet.quiknode.pro/${process.env.SHYFT_KEY}`,
